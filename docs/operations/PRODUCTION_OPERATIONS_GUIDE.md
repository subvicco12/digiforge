...
- Current live deployed plugin baseline: 1.0.31
...
- Schema version 14 is the current certified database baseline. Fresh read-only production verification on 2026-09-25 confirms plugin release 1.0.31 live with schema 14 / 14, recovery PASS and READY_LOCKED.
