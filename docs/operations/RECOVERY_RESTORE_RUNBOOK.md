...
- Current live DigiForge release: 1.0.31
- Repository-certified release: 1.0.31
...
6. Install or retain the audited DigiForge 1.0.31 plugin package matching the currently verified live deployment. Verify its recorded checksum before use; do not substitute a different package merely because it is newer.
