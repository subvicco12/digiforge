...
final class Capabilities {
    public const ALL = ['manage_digiforge','manage_digiforge_products','manage_digiforge_research','manage_digiforge_automation','manage_digiforge_connections','manage_digiforge_settings','publish_digiforge','view_digiforge_analytics'];
