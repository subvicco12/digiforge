...
final class Controller {
    ...
    public function activate_etsy_publish(\WP_REST_Request $request): \WP_REST_Response|\WP_Error {
        return $this->activateScoped(new EtsyPublishActivationPreflight(), 'READY_FOR_CONTROLLED_ETSY_PUBLISH_ACTIVATION', 'etsy_publish', 'activateEtsyPublish');
    }
    public function activate_order_automation(\WP_REST_Request $request): \WP_REST_Response|\WP_Error {
        return $this->activateScoped(new OrderAutomationActivationPreflight(), 'READY_FOR_CONTROLLED_ORDER_AUTOMATION_ACTIVATION', 'order_automation', 'activateOrderAutomation');
    }
    public function activate_gst_automation(\WP_REST_Request $request): \WP_REST_Response|\WP_Error {
        return $this->activateScoped(new GstAutomationActivationPreflight(), 'READY_FOR_CONTROLLED_GST_AUTOMATION_ACTIVATION', 'gst_automation', 'activateGstAutomation');
    }
    private function activateScoped(object $preflightService, string $readyStatus, string $capability, string $method): \WP_REST_Response|\WP_Error {
