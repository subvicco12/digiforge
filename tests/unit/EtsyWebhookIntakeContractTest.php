...
final class EtsyWebhookIntakeContractTest extends TestCase {
 ...
 public function testDedupUsesAtomicInsertIgnore():void{$s=(string)file_get_contents(dirname(__DIR__,2).'/includes/Listings/EtsyWebhookDeduplicator.php');self::assertStringContainsString('INSERT IGNORE',$s);self::assertStringContainsString('digiforge_idempotency',$s);self::assertStringContainsString("'process_permitted'=>false",$s);}
}
