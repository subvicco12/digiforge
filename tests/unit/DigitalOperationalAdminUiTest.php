...
final class DigitalOperationalAdminUiTest extends TestCase {
 public function testOperationalSnapshotIsReadOnlyAndScoped():void{
  ...
  self::assertStringContainsString("['digital_file','digital_file_version','digital_preview','digital_template']",$s);
  ...
  self::assertStringContainsString("'digital_file_version'=>'Digital File Versions'",$s);
