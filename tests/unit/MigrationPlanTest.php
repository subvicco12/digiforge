...
final class MigrationPlanTest extends TestCase
{
    ...
    {
        self::assertSame([1, 2, 3, 4, 5, 6], MigrationPlan::pending(0));
        self::assertSame([3, 4, 5, 6], MigrationPlan::pending(2));
        self::assertSame([5, 6], MigrationPlan::pending(4));
        self::assertSame([6], MigrationPlan::pending(5));
