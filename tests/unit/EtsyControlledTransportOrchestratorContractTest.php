...
final class EtsyControlledTransportOrchestratorContractTest extends TestCase
{
    public function testOrchestratorComposesControlledPreNetworkPath(): void
    {
        ...
        foreach(['EtsyConsumedPermitHandoff::validate','EtsyAdapterInvocationPlan::build','EtsyTokenAcquisitionGate::evaluate','EtsyScopedCredentialAccess::authorize','EtsyHttpRequestPlan::build','EtsyScopedCredentialRetriever','EtsyCredentialAwareTransport'] as $needle) {
