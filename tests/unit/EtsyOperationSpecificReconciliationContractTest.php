...
final class EtsyOperationSpecificReconciliationContractTest extends TestCase
{
 ...
 public function testBinaryImageHashCannotBeInventedAsProviderProof():void{$s=(string)file_get_contents(dirname(__DIR__,2).'/includes/Listings/EtsyOperationSpecificReconciliation.php');self::assertStringContainsString("hash is not exposed by Etsy's image read model",$s);self::assertStringContainsString('image_evidence_mismatch',$s);}
}
