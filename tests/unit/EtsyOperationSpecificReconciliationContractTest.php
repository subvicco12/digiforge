...
final class EtsyOperationSpecificReconciliationContractTest extends TestCase
{
 ...
 public function testBinaryImageHashCannotBeInventedAsProviderProof():void{$s=(string)file_get_contents(dirname(__DIR__,2).'/includes/Listings/EtsyOperationSpecificReconciliation.php');self::assertStringContainsString('content hash is not exposed',$s);self::assertStringContainsString('image_evidence_mismatch',$s);}
}
