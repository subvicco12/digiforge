...
/** Final admin/operations convergence certificate for the locked DigiForge release. */
final class AdminOperationsFinalCertificationTest extends TestCase{
 ...
 public function testProtectedControlsCannotReleaseStopAllThroughGenericSwitchUpdate():void{
  ...
  foreach(["if ($key === 'stop_all' && ! $enabled)",'Use the protected Production Activation action','activation_authorized','automation_armed'] as $x)self::assertStringContainsString($x,$s);
 }
