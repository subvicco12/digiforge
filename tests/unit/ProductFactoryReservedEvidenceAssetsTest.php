...
final class ProductFactoryReservedEvidenceAssetsTest extends TestCase {
 public function test_ai_cannot_duplicate_deterministic_evidence_assets():void {
  ...
  self::assertStringContainsString("['delivery-manifest','license-provenance']", $source);
  self::assertStringContainsString("['delivery-manifest.json','license-and-provenance.txt']", $source);
