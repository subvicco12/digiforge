...
final class EtsyCredentialEnvelopeContractTest extends TestCase
{
    ...
    {
        $s=$this->source();
        foreach(['ETSY_SCOPED_CREDENTIAL_ACCESS_AUTHORIZED','single_use','integrationId','operationId','private bool $consumed=false','$this->consumed=true','$this->material=[]'] as $needle) {
