...
final class EtsyReconciliationWorkflowContractTest extends TestCase
{
 ...
 public function testWorkflowReloadsPersistedOperationAndSerializesTransitions():void{$s=$this->source();foreach(['acquireExecutionLock','->find($operationId)','EtsyOperationLifecycle::UNKNOWN','EtsyReconciliationPlan::build','EtsyReconciliationLookupPlan','EtsyReconciliationService','EtsyOperationLifecycle::RECONCILIATION','EtsyOperationLifecycle::RECONCILED','EtsyReconciliationResultService','releaseExecutionLock'] as $n)self::assertStringContainsString($n,$s);}
