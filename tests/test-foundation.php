...
expect(str_contains($bootstrap, '* Version: 1.0.48'), 'plugin header release version is current');
expect(str_contains($bootstrap, "const DIGIFORGE_VERSION = '1.0.48';"), 'runtime release version is current');
