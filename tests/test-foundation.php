...
expect(str_contains($bootstrap, '* Version: 1.0.44'), 'plugin header release version is current');
expect(str_contains($bootstrap, "const DIGIFORGE_VERSION = '1.0.44';"), 'runtime release version is current');
