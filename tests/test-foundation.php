...
expect(str_contains($bootstrap, '* Version: 1.0.46'), 'plugin header release version is current');
expect(str_contains($bootstrap, "const DIGIFORGE_VERSION = '1.0.46';"), 'runtime release version is current');
