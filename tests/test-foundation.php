...
expect(str_contains($bootstrap, '* Version: 1.0.45'), 'plugin header release version is current');
expect(str_contains($bootstrap, "const DIGIFORGE_VERSION = '1.0.45';"), 'runtime release version is current');
