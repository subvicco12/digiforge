...
df_expect(str_contains($bootstrap, '* Version: 0.9.0') && str_contains($bootstrap, "DIGIFORGE_VERSION = '0.9.0'") && str_contains($bootstrap, "DIGIFORGE_DB_VERSION = '12'"), 'versions synchronized');
