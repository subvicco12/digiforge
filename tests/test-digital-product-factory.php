...
df_expect(str_contains($bootstrap, '* Version: 1.0.35') && str_contains($bootstrap, "DIGIFORGE_VERSION = '1.0.35'") && str_contains($bootstrap, "DIGIFORGE_DB_VERSION = '14'"), 'versions synchronized');
