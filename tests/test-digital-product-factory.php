...
df_expect(str_contains($bootstrap, '* Version: 0.11.2') && str_contains($bootstrap, "DIGIFORGE_VERSION = '0.11.2'") && str_contains($bootstrap, "DIGIFORGE_DB_VERSION = '13'"), 'versions synchronized');
