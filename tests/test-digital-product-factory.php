...
df_expect(str_contains($bootstrap, '* Version: 0.13.0') && str_contains($bootstrap, "DIGIFORGE_VERSION = '0.13.0'") && str_contains($bootstrap, "DIGIFORGE_DB_VERSION = '13'"), 'versions synchronized');
