...
pf_expect(str_contains($bootstrap, '* Version: 0.5.0'), 'plugin header version matches the runtime version');
pf_expect(str_contains($bootstrap, "DIGIFORGE_VERSION = '0.5.0'"), 'runtime version is 0.5.0');
