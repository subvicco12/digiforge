...
pf_expect(str_contains($bootstrap, '* Version: 0.4.0'), 'plugin header version matches the runtime version');
pf_expect(str_contains($bootstrap, "DIGIFORGE_VERSION = '0.4.0'"), 'runtime version is 0.4.0');
