...
pf_expect(str_contains($bootstrap, '* Version: 1.0.52'), 'plugin header version matches the runtime version');
pf_expect(str_contains($bootstrap, "DIGIFORGE_VERSION = '1.0.52'"), 'runtime version is 1.0.52');
