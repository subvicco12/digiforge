...
pf_expect(str_contains($bootstrap, '* Version: 0.11.1'), 'plugin header version matches the runtime version');
pf_expect(str_contains($bootstrap, "DIGIFORGE_VERSION = '0.11.1'"), 'runtime version is 0.11.1');
