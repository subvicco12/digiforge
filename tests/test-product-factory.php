...
pf_expect(str_contains($bootstrap, '* Version: 1.0.12'), 'plugin header version matches the runtime version');
pf_expect(str_contains($bootstrap, "DIGIFORGE_VERSION = '1.0.12'"), 'runtime version is 1.0.12');
